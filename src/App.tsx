...
function App() {
  ...
  // Styles dengan tema hitam putih monochrome
  const styles = {
    container: {
      minHeight: '100vh',
      background: '#ffffff',
        ...
        <div style={styles.innerContainer}>
          ...
          <div style={styles.stats}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'clamp(12px, 4vw, 16px)', textAlign: 'center' as const }}>
              <div>
                <p style={{ fontSize: 'clamp(20px, 6vw, 24px)', fontWeight: 'bold', color: '#000000' }}>{history.length}</p>
                <p style={{ fontSize: 'clamp(11px, 3vw, 12px)', color: '#666666' }}>Total Ganti Oli</p>
              </div>
              <div>
                <p style={{ fontSize: 'clamp(20px, 6vw, 24px)', fontWeight: 'bold', color: '#000000' }}>
                  {history.filter(h => h.daysLeft > 0).length}
                </p>
                <p style={{ fontSize: 'clamp(11px, 3vw, 12px)', color: '#666666' }}>Masih Berlaku</p>
              </div>
            </div>
          </div>
        </div>
    ...
    return (
      <div style={styles.container}>
        <div style={styles.innerContainer}>
          ...
          <h1 style={{...styles.title, marginTop: 0, textAlign: 'left', marginBottom: '24px'}}>📝 Catat Ganti Oli</h1>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '32px' }}>
            <button
              ...
              style={{
                padding: '20px 12px',
                border: `2px solid ${selectedOli === 'mesin' ? '#000000' : '#e0e0e0'}`,
                background: selectedOli === 'mesin' ? '#000000' : '#ffffff',
                borderRadius: '12px',
                cursor: 'pointer',
                textAlign: 'center' as const,
                color: selectedOli === 'mesin' ? 'white' : '#000000',
                transition: 'all 0.2s ease'
              }}
            >
              <div style={{ fontSize: '32px', marginBottom: '8px' }}>🛢️</div>
              <div style={{ fontWeight: '600', fontSize: '16px' }}>Oli Mesin</div>
              <div style={{ fontSize: '12px', opacity: 0.7 }}>{settings.oliMesinInterval} hari</div>
            </button>
            ...
            <button
              ...
              style={{
                padding: '20px 12px',
                border: `2px solid ${selectedOli === 'gardan' ? '#000000' : '#e0e0e0'}`,
                background: selectedOli === 'gardan' ? '#000000' : '#ffffff',
                borderRadius: '12px',
                cursor: 'pointer',
                textAlign: 'center' as const,
                color: selectedOli === 'gardan' ? 'white' : '#000000',
                transition: 'all 0.2s ease'
              }}
            >
              <div style={{ fontSize: '32px', marginBottom: '8px' }}>⚙️</div>
              <div style={{ fontWeight: '600', fontSize: '16px' }}>Oli Gardan</div>
              <div style={{ fontSize: '12px', opacity: 0.7 }}>{settings.oliGardanInterval} hari</div>
            </button>
          </div>
        ...
        <div style={styles.notificationContainer}>
          {notifications.map((notification) => (
            ...
            >
              ...
              <span style={{ flex: 1, color: '#000000' }}>{notification.message}</span>
            </div>
          ))}
        </div>
      </div>
    ...
    return (
      <div style={styles.container}>
        <div style={styles.innerContainer}>
          ...
          <h1 style={{...styles.title, marginTop: 0, textAlign: 'left', marginBottom: '24px'}}>📋 Riwayat Maintenance</h1>
          ...
          {history.length === 0 ? (
            <div style={{
              ...
              <Calendar size={48} style={{ margin: '0 auto 16px', color: '#999999' }} />
              <h3 style={{ color: '#000000', marginBottom: '8px' }}>Belum ada riwayat</h3>
              <p style={{ color: '#666666', marginBottom: '24px' }}>Catat ganti oli pertama Anda</p>
              <button 
                onClick={() => setCurrentView('add')}
                style={{
                  ...styles.button, 
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                        <div style={{
                          ...
                          height: '12px',
                          borderRadius: '50%',
                          background: entry.type === 'mesin' ? '#000000' : '#404040'
                        }} />
                        <span style={{ fontWeight: '600', color: '#000000', fontSize: '16px' }}>
    ...
    return (
      <div style={styles.container}>
        <div style={styles.innerContainer}>
          ...
          <h1 style={{...styles.title, marginTop: 0, textAlign: 'left', marginBottom: '24px'}}>⚙️ Pengaturan</h1>
          ...
          <div style={{ 
            ...
            <p style={{ fontWeight: '600', marginBottom: '4px', color: '#000000' }}>OliReminder v1.0.0</p>
  ...
  return (
    <div style={styles.container}>
      <div style={styles.innerContainer}>
        <div style={{ textAlign: 'center', color: '#000000', padding: '40px 20px' }}>
